...
You can find the updated header file here and the implementation file [here](https://www.gem5.org/_pages/static/scripts/part2/events/hello_object.cc).
...
We find that time.sleep works as code logic expect.
